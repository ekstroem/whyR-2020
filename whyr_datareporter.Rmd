...
<!-- knitr::include_graphics("pics/refcatdocu.png") -->
<!-- ``` -->
...
-------------------------------------------------------------------------------
```
<!-- Note: Same default for all classes (`standardVisual`). -->

---


# Bulit-in check functions (1/3)
...
Get in touch at https://github.com/ekstrom/dataReporter if you
